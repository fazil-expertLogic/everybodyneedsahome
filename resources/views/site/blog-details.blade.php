                ...
                <div class="col-lg-12">
                    <div class="blog-banner">
                        <div class="blog-banner-img">
                            <img src="{{ URL::asset('/assets/img/blog/blog-banner.jpg') }}" alt="img">
                        </div>
                    ...
                    <div class="blog-para-content">
                        ...
                        <img src="{{ URL::asset('/assets/img/blog/blog-banner1.jpg') }}" alt="img">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="testimonial-slider testimonialnext-prev owl-carousel">
                        <div class="blog-card">
                            <div class="blog-img">
                                <a href="javascript:void(0);"><img src="{{ URL::asset('/assets/img/blog/blog-1.jpg') }}"
                                        alt="Blog Image"></a>
                            </div>
                        ...
                        <div class="blog-card">
                            <div class="blog-img">
                                <a href="javascript:void(0);"><img src="{{ URL::asset('/assets/img/blog/blog-2.jpg') }}"
                                        alt="Blog Image"></a>
                            </div>
                            <div class="blog-content">
                                <div class="blog-property">
                        ...
                        <div class="blog-card">
                            <div class="blog-img">
                                <a href="javascript:void(0);"><img src="{{ URL::asset('/assets/img/blog/blog-3.jpg') }}"
                                        alt="Blog Image"></a>
                            </div>
                            <div class="blog-content">
                                <div class="blog-property">
