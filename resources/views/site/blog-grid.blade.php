            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-6">
                    ...
                    <div class="blog-card" data-aos="fade-down" data-aos-duration="2000">
                        <div class="blog-img">
                            <a href="{{ url('blog-details') }}"><img src="{{ URL::asset('/assets/img/blog/blog-1.jpg') }}"
                                    alt="Blog Image"></a>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    ...
                    <div class="blog-card" data-aos="fade-down" data-aos-duration="2000">
                        <div class="blog-img">
                            <a href="{{ url('blog-details') }}"><img src="{{ URL::asset('/assets/img/blog/blog-2.jpg') }}"
                                    alt="Blog Image"></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-property">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    ...
                    <div class="blog-card" data-aos="fade-down" data-aos-duration="2000">
                        <div class="blog-img">
                            <a href="{{ url('blog-details') }}"><img src="{{ URL::asset('/assets/img/blog/blog-3.jpg') }}"
                                    alt="Blog Image"></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-property">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    ...
                    <div class="blog-card" data-aos="fade-down" data-aos-duration="2000">
                        <div class="blog-img">
                            <a href="{{ url('blog-details') }}"><img src="{{ URL::asset('/assets/img/blog/blog-4.jpg') }}"
                                    alt="Image"></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-property">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    ...
                    <div class="blog-card" data-aos="fade-down" data-aos-duration="2000">
                        <div class="blog-img">
                            <a href="{{ url('blog-details') }}"><img src="{{ URL::asset('/assets/img/blog/blog-5.jpg') }}"
                                    alt="Image"></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-property">
                    ...
                    <div class="blog-card aos" data-aos="fade-down" data-aos-duration="2000">
                        <div class="blog-img">
                            <a href="{{ url('blog-details') }}"><img
                                    src="{{ URL::asset('/assets/img/blog/blog-6.jpg') }}" alt="Image"></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-property">
                                <span>House</span>
