        ...
        <div class="details-wrap">
            <div class="detail-user-wrap">
                <div class="detail-user-img">
                    <img src="{{URL::asset('assets/img/agents/agent-01.jpg')}}" class="img-fluid" alt="Image">
                </div>
                <div class="user-wrap">
                                ...
                                <div class="agentview-slider owl-carousel feature-property-sec for-rent">
                                        ...
                                        <div class="profile-widget">
                                            <div class="pro-img">
                                                <a href="{{url('rent-details')}}" class="property-img">
                                                    <img class="img-fluid" alt="Property Image" src="{{URL::asset('assets/img/product/product-7.jpg')}}">
                                                </a>
                                            ...
                                            <div class="pro-content">
                                                ...
                                                <ul class="property-category d-flex justify-content-between align-items-center">
                                                    <li class="user-info">
                                                        <a href="javascript:void(0);"><img src="{{URL::asset('assets/img/profiles/avatar-02.jpg')}}" class="img-fluid avatar" alt="User"></a>
                                                        <div class="user-name">
                                    ...
                                    <div class="product-custom">
                                        <div class="profile-widget">
                                            <div class="pro-img">
                                                <a href="{{url('rent-details')}}" class="property-img">
                                                    <img class="img-fluid" alt="Property Image" src="{{URL::asset('assets/img/product/product-8.jpg')}}">
                                                </a>
                                                <div class="product-amount">
                                            ...
                                            <div class="pro-content">
                                                ...
                                                <ul class="property-category d-flex justify-content-between align-items-center">
                                                    <li class="user-info">
                                                        <a href="javascript:void(0);"><img src="{{URL::asset('assets/img/profiles/avatar-03.jpg')}}" class="img-fluid avatar" alt="User"></a>
                                                        <div class="user-name">
                                    ...
                                    <div class="product-custom">
                                        <div class="profile-widget">
                                            <div class="pro-img">
                                                <a href="{{url('rent-details')}}" class="property-img">
                                                    <img class="img-fluid" alt="Property Image" src="{{URL::asset('assets/img/product/product-9.jpg')}}">
                                                </a>
                                                <div class="product-amount">
                                            ...
                                            <div class="pro-content">
                                                ...
                                                <ul class="property-category d-flex justify-content-between align-items-center">
                                                    <li class="user-info">
                                                        <a href="javascript:void(0);"><img src="{{URL::asset('assets/img/profiles/avatar-04.jpg')}}" class="img-fluid avatar" alt="User"></a>
                                                        <div class="user-name">
                        ...
                        <div id="review" class="card-collapse collapse show  collapse-view">
                            <div class="review-card">
                                <div class="customer-review">
                                    <div class="customer-info">
                                        <div class="customer-name">
                                            <a href="javascript:void(0);"><img src="{{URL::asset('assets/img/profiles/avatar-01.jpg')}}" alt="User"></a>
                                            <div>
                                ...
                                <div class="customer-review">
                                    <div class="customer-info">
                                        <div class="customer-name">
                                            <a href="javascript:void(0);"><img src="{{URL::asset('assets/img/profiles/avatar-02.jpg')}}" alt="User"></a>
                                            <div>
