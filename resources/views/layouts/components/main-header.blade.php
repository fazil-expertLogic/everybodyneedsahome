								...
								<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
									...
									<div class="header-dropdown-list message-menu">
										<div class="dropdown-item d-flex">
											...
											<div class="wd-50p d-flex flex-column">
												<a href="javascript:void(0)" class="p-0 h6 text-dark fw-semibold mb-0">Flower pot home decores</a>
												<span>Qty: 1</span>
										...
										<div class="dropdown-item d-flex">
											...
											<div class="wd-50p d-flex flex-column">
												<a href="javascript:void(0)" class="p-0 h6 text-dark fw-semibold mb-0">Smart watch</a>
												<span>Qty: 3</span>
										...
										<div class="dropdown-item d-flex">
											...
											<div class="wd-50p d-flex flex-column">
												<a href="javascript:void(0)" class="p-0 h6 text-dark fw-semibold mb-0">Headphones</a>
												<span>Qty: 2</span>
												<span>Status: <span class="text-success">In
														Stock</span></span>
											</div>
										...
										<div class="dropdown-item d-flex">
											...
											<div class="wd-50p d-flex flex-column">
												<a href="javascript:void(0)" class="p-0 h6 text-dark fw-semibold mb-0">Furniture (chair)</a>
												<span>Qty: 1</span>
												<span>Status: <span class="text-success">In
														Stock</span></span>
											</div>
										...
										<div class="dropdown-item d-flex border-bottom-0">
											...
											<div class="wd-50p d-flex flex-column">
												<a href="javascript:void(0)" class="p-0 h6 text-dark fw-semibold mb-0">Running Shoes</a>
												<span>Qty: 4</span>
									...
									<div class="dropdown-footer d-felx justify-content-between align-items-center">
										<a class="btn btn-primary btn-pill btn-sm"
											href="javascript:void(0)"><i class="fe fe-check-circle"></i>
											CHECKOUT</a>
							...
							<div class="dropdown d-flex notifications nav-link-notify">
								...
								<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow ">
									...
									<div class="text-center dropdown-footer">
										<a class="btn btn-primary btn-sm btn-block text-center" href="javascript:void(0)">VIEW ALL NOTIFICATIONS</a>
									</div>
								</div>
							</div>
							<!-- NOTIFICATIONS -->
							<div class="dropdown d-flex message">
								...
								<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
									...
									<div class="message-menu message-menu-scroll">
										<a class="dropdown-item border-bottom d-flex align-items-center" href="javascript:void(0)">
										...
										<a class="dropdown-item border-bottom d-flex align-items-center border-bottom-0" href="javascript:void(0)">
											<img class="avatar avatar-md brround cover-image"
									...
									<div class="text-center dropdown-footer">
										<a class="btn btn-primary btn-sm btn-block text-center" href="javascript:void(0)">MARK ALL AS READ</a>
									</div>
								</div>
							</div>
							<!-- MESSAGE-BOX -->
