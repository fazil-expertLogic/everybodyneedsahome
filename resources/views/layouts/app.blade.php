...
<html lang="en" dir="ltr">
	<head>
        ...
        <meta name="Description" content="EverybodyNeedsAHome">
        <meta name="Author" content="Hope For Everybody, LLC">
        <meta name="keywords" content="Hope For Everybody, LLC">
		...
		<link rel="shortcut icon" href="{{asset('build/assets/images/brand/favicon.png')}}" type="image/x-icon">
