                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_order_by @if ($errors->has('order_by')) has-error has-danger @endif">
                                                    ...
                                                    <input type="number" name="order_by" class="form-control py-2" id="order_by" placeholder="order by" value="{{old('order_by',$menu->order_by)}}" required data-error="Please enter order by">
                                                    <div class="help-block with-errors"></div>
