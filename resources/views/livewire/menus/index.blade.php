                        ...
                        <table class="table table-bordered text-nowrap border-bottom" id="responsive-datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($allow_show)
                                        <a href="{{ route('menus.show', $menu->id) }}" class="btn btn-warning btn-sm badge" title="Show">
                                            <i class="fa fa-eye" aria-hidden="true"></i>
                                        </a>
                                        @endif
                                        @if($allow_edit)
                                        <a href="{{ route('menus.edit', $menu->id) }}" class="btn btn-primary btn-sm badge" title="Edit">
