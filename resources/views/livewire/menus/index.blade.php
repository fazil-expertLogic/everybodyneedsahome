        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="mb-3 text-end">
                    @if ($allow_create)
                        <a href="{{ route('menus.create') }}" class="btn bg-primary btn-sm badge" data-bs-toggle="tooltip"
                            title="Add New">
                ...
                {{--  --------------------------------- export ------------------------------------- --}}
                <form action="{{ route('menus.export') }}" method="get">
                    <div class="mb-3 text-end">
                        <div class="input-group w-100">
                            <div class="col">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered text-nowrap border-bottom" id="responsive-datatable">
                            <thead>
                                <tr>
                                    <th class="wd-15p border-bottom-0">Menu Name</th>
                                    <th class="wd-15p border-bottom-0">Menu Icon</th>
                                        ...
                                        <td>
                                            ...
                                            @if ($allow_delete)
                                                <button class="btn btn-danger btn-sm badge" title="Delete"
                                                    onclick="confirmDelete('{{ route('menus.destroy', $menu->id) }}');">
    ...
    <div class="modal fade" id="import" tabindex="-1" aria-labelledby="formModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('menus.import') }}" method="POST" enctype="multipart/form-data" id="modalForm">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
