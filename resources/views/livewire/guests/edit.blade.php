                            ...
                            <div class="signUpForm-step-holder">
                                <div id="section-1" class="signUpForm-step-wrap">
                                    ...
                                    <fieldset>
                                        ...
                                        <input type="text" name="is_edit" class="form-control py-2" value="edit" id="is_edit">
                                        <div class="row">
                                            <div class="col-sm-6 col-lg-6">
                                                ...
                                                <div class="form-group valid_name @if($errors->has('name')) has-error has-danger @endif">
                                                    ...
                                                    <input type="text" name="name" class="form-control py-2" value="{{old('name',$guest->name)}}" id="name" placeholder="Your name" required data-error="Please enter name">
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_email">
                                                    ...
                                                    <input type="email" name="email" class="form-control py-2" id="email" placeholder="" value="{{old('email',$guest->email)}}" required data-error="Please enter email">
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_ssn @if($errors->has('ssn')) has-error has-danger @endif">
                                                    ...
                                                    <input type="text" name="ssn" class="form-control py-2" id="ssn" placeholder="" value="{{old('ssn',$guest->ssn)}}" required data-error="Please enter Social Security Number">
                                                    <div class="help-block with-errors"></div>
                                                    @if ($errors->has('ssn'))
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_dob">
                                                    ...
                                                    <input type="date" name="dob" class="form-control py-2"id="dob" placeholder="" value="{{old('dob',$guest->dob)}}" required data-error="Please enter Date of Birth">
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-lg-6 form-group valid_address">
                                                ...
                                                <input type="text" class="form-control" id="address" name="address" value="{{old('address',$guest->address)}}" required data-error="Please enter address">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-lg-6 form-group valid_address2">
                                                ...
                                                <input type="text" class="form-control" id="address2" name="address2" value="{{old('address2',$guest->address2)}}" required data-error="Please enter address">
                                                <div class="help-block with-errors"></div>
                                            </div>
    
                                            <div class="col-sm-6 col-lg-6 form-group valid_city">
                                                <label for="city" class="form-label">City<span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="city" name="city" value="{{old('city',$guest->city)}}" required data-error="Please enter city">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_zip_code">
                                                    ...
                                                    <input type="text" name="zip_code" maxlength="10" class="form-control py-2 zip-input-mask" id="zip_code" placeholder="Zip Code" value="{{old('zip_code',$guest->zip)}}" required data-error="Please enter Zip Code">
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_phone">
                                                    ...
                                                    <input type="text" name="phone"  maxlength="11" class="form-control py-2 phone-input-mask" id="phone" placeholder="Phone" value="{{old('phone',$guest->phone)}}" required data-error="Please enter phone">
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 col-lg-6">
                                                        <div class="form-group valid_eviction_property_name">
                                                            ...
                                                            <input type="text" name="eviction_property_name" class="form-control py-2 zip-input-mask" id="eviction_property_name" placeholder="Property Name" value="{{old('eviction_property_name',$guest->eviction_property_name)}}" data-error="Please enter Property Name">
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6 col-lg-6">
                                                        <div class="form-group valid_eviction_manager_name">
                                                            ...
                                                            <input type="text" name="eviction_manager_name" class="form-control py-2 zip-input-mask" id="eviction_manager_name" placeholder="Manager Name" value="{{old('eviction_manager_name',$guest->eviction_manager_name)}}" data-error="Please enter Manager Name">
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6 col-lg-6">
                                                        <div class="form-group valid_eviction_address">
                                                            ...
                                                            <input type="text" name="eviction_address" class="form-control py-2 zip-input-mask" id="eviction_address" placeholder="Eviction Address" value="{{old('eviction_address',$guest->eviction_address)}}" data-error="Please enter Property Name">
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6 col-lg-6">
                                                        <div class="form-group valid_eviction_phone">
                                                            ...
                                                            <input type="text" name="eviction_phone" maxlength="11" class="form-control py-2 eviction_phone-input-mask" id="eviction_phone" placeholder="Eviction Phone" value="{{old('eviction_phone',$guest->eviction_phone)}}" data-error="Please enter eviction_phone">
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6 col-lg-6">
                                                        <div class="form-group valid_eviction_date">
                                                            ...
                                                            <input type="date" name="eviction_date" class="form-control py-2"id="eviction_date" placeholder="" value="{{old('eviction_date',$guest->eviction_date)}}" data-error="Please enter Date of Eviction">
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6 col-lg-6 form-group valid_eviction_comments">
                                                        ...
                                                        <textarea class="form-control" id="eviction_comments" name="eviction_comments"  data-error="Please select">{{$guest->eviction_comments}}</textarea>
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 col-lg-6">
                                                        <div class="form-group valid_conviction_year">
                                                            ...
                                                            <input type="text" name="conviction_year" class="form-control py-2" id="conviction_year" placeholder="Conviction Year" value="{{old('conviction_year',$guest->conviction_year)}}" data-error="Please enter Conviction Year">
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6 col-lg-6">
                                                        <div class="form-group valid_conviction_charge">
                                                            ...
                                                            <input type="text" name="conviction_charge" class="form-control py-2" id="conviction_charge" placeholder="Charge/Conviction" value="{{old('conviction_charge',$guest->conviction_charge)}}" data-error="Please enter Charge/Conviction">
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6 col-lg-6">
                                                        <div class="form-group valid_conviction_sentence">
                                                            ...
                                                            <input type="text" name="conviction_sentence" class="form-control py-2" id="conviction_sentence" placeholder="Sentence" value="{{old('conviction_sentence',$guest->conviction_sentence)}}" data-error="Please enter Sentence">
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6 col-lg-6">
                                                                <div class="form-group valid_age_difference">
                                                                    ...
                                                                    <input type="text" name="age_difference" class="form-control py-2" id="age_difference" placeholder="Age Difference" value="{{old('age_difference',$guest->age_difference)}}" data-error="Please enter Age Difference">
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6 col-lg-6">
                                                                <div class="form-group valid_probation_officer_name">
                                                                    ...
                                                                    <input type="text" name="probation_officer_name" class="form-control py-2" id="probation_officer_name" placeholder="Supervising Officer Name" value="{{old('probation_officer_name',$guest->probation_officer_name)}}" data-error="Please enter Supervising Officer Name">
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6 col-lg-6">
                                                                <div class="form-group valid_probation_officer_phone">
                                                                    ...
                                                                    <input type="text" name="probation_officer_phone" maxlength="11" class="form-control py-2" id="probation_officer_phone" placeholder="Supervising Officer Phone" value="{{old('probation_officer_phone',$guest->probation_officer_phone)}}" data-error="Please enter Supervising Officer Phone">
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6 col-lg-6">
                                                                <div class="form-group valid_probation_officer_email">
                                                                    ...
                                                                    <input type="text" name="probation_officer_email" class="form-control py-2" id="probation_officer_email" placeholder="Supervising Officer Email" value="{{old('probation_officer_email',$guest->probation_officer_email)}}" data-error="Please enter Supervising Officer Email">
                                                                    <div class="help-block with-errors"></div>
                                                                </div>
                                                            </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-lg-6 form-group valid_ref1_name">
                                                ...
                                                <input type="text" class="form-control" value="{{old('ref1_name',$guest->ref1_name)}}" id="ref1_name" name="ref1_name" data-error="Please enter Reference 1 - Name">
                                                <div class="help-block with-errors"></div>
                                            </div>
    
                                            <div class="col-sm-6 col-lg-6 form-group valid_ref1_phone">
                                                <label for="ref1_phone">Phone<span class="text-danger">*</span></label>
                                                <input type="text" maxlength="11" class="form-control" value="{{old('ref1_phone',$guest->ref1_phone)}}" id="ref1_phone" name="ref1_phone" data-error="Please enter Reference 1 - Phone">
                                                <div class="help-block with-errors"></div>
                                            </div>
    
                                            <div class="col-sm-6 col-lg-6 form-group valid_ref1_email">
                                                <label for="ref1_email">Email<span class="text-danger">*</span></label>
                                                <input type="email" class="form-control" value="{{old('ref1_email',$guest->ref1_email)}}" id="ref1_email" name="ref1_email" data-error="Please enter Reference 1 - Email">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-lg-6 form-group valid_ref2_name">
                                                ...
                                                <input type="text" class="form-control" value="{{old('ref2_name',$guest->ref2_name)}}" id="ref2_name" name="ref2_name" data-error="Please enter Reference 2 - Name">
                                                <div class="help-block with-errors"></div>
                                            </div>
    
                                            <div class="col-sm-6 col-lg-6 form-group valid_ref2_phone">
                                                <label for="ref2_phone">Phone<span class="text-danger">*</span></label>
                                                <input type="text" maxlength="11" class="form-control" value="{{old('ref2_phone',$guest->ref2_phone)}}" id="ref2_phone" name="ref2_phone" data-error="Please enter Reference 2 - Phone">
                                                <div class="help-block with-errors"></div>
                                            </div>
    
                                            <div class="col-sm-6 col-lg-6 form-group valid_ref2_email">
                                                <label for="ref2_email">Email<span class="text-danger">*</span></label>
                                                <input type="email" class="form-control" value="{{old('ref2_email',$guest->ref2_email)}}" id="ref2_email" name="ref2_email" data-error="Please enter Reference 2 - Email">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-lg-6 form-group valid_ref3_name">
                                                ...
                                                <input type="text" class="form-control" value="{{old('ref3_name',$guest->ref3_name)}}" id="ref3_name" name="ref3_name" data-error="Please enter Reference 3 - Name">
                                                <div class="help-block with-errors"></div>
                                            </div>
    
                                            <div class="col-sm-6 col-lg-6 form-group valid_ref3_phone">
                                                <label for="ref3_phone">Phone<span class="text-danger">*</span></label>
                                                <input type="text" maxlength="11" class="form-control" value="{{old('ref3_phone',$guest->ref3_phone)}}" id="ref3_phone" name="ref3_phone" data-error="Please enter Reference 3 - Phone">
                                                <div class="help-block with-errors"></div>
                                            </div>
    
                                            <div class="col-sm-6 col-lg-6 form-group valid_ref3_email">
                                                <label for="ref3_email">Email<span class="text-danger">*</span></label>
                                                <input type="email" class="form-control" value="{{old('ref3_email',$guest->ref3_email)}}" id="ref3_email" name="ref3_email" data-error="Please enter Reference 3 - Email">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                            <div class="col-sm-6 col-lg-6">
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-lg-6 form-group valid_emergency_contact_name">
                                                ...
                                                <input type="text" class="form-control" value="{{old('emergency_contact_name',$guest->emergency_contact_name)}}" id="emergency_contact_name" name="emergency_contact_name" data-error="Please enter Reference 3 - Name">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-lg-6 form-group valid_emergency_contact_phone">
                                                ...
                                                <input type="text" maxlength="11" class="form-control" value="{{old('emergency_contact_phone',$guest->emergency_contact_phone)}}" id="emergency_contact_phone" name="emergency_contact_phone" data-error="Please enter Reference 3 - Phone">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-lg-6 form-group valid_emergency_contact_email">
                                                ...
                                                <input type="text" class="form-control" value="{{old('emergency_contact_email',$guest->emergency_contact_email)}}" id="emergency_contact_email" name="emergency_contact_email" data-error="Please enter Reference 3 - Email">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-lg-6 form-group valid_employer_name">
                                                ...
                                                <input type="text" class="form-control" value="{{old('employer_name',$guest->employer_name,)}}" id="employer_name" name="employer_name" data-error="Please Enter Employer Name">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-lg-6 form-group valid_employer_phone">
                                                ...
                                                <input type="text" class="form-control" value="{{old('employer_phone',$guest->employer_phone)}}" id="employer_phone" name="employer_phone" data-error="Please Enter Employer Phone">
                                                <div class="help-block with-errors"></div>
                                            </div>
    
                                            <div class="col-sm-6 col-lg-6 form-group valid_income">
                                                <label for="income"> Monthly Income ($)<span class="text-danger">*</span></label>
                                                <input type="number" class="form-control" value="{{old('income',$guest->income)}}" id="income" name="income" data-error="Please Enter Income">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-lg-6 form-group valid_expenses">
                                                ...
                                                <input type="number" class="form-control" value="{{old('expenses',$guest->expenses)}}" id="expenses" name="expenses" data-error="Please Enter expenses">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-lg-6 form-group valid_rental_budget">
                                                ...
                                                <input type="number" class="form-control" value="{{old('rental_budget',$guest->rental_budget)}}" id="rental_budget" name="rental_budget" data-error="Please Enter Rental Budget">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
