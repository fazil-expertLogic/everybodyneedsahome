        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="mb-3 text-end">
                    @if ($allow_create)
                        <a href="{{ route('guests.create') }}" class="btn bg-primary ms-auto" data-bs-toggle="tooltip"
                            title="Add New">
                ...
                {{--  --------------------------------- export ------------------------------------- --}}
                <form action="{{ route('guests.export') }}" method="get">
                    <div class="mb-3 text-end">
                        <div class="input-group w-100">
                            <div class="col">
                                        ...
                                        <td>
                                            ...
                                            @if ($allow_edit)
                                                <a href="{{ route('guests.edit', $guest->id) }}"
                                                    class="btn  btn-primary btn-sm badge" type="button" title="Edit">
                                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                </a>
                                            @endif
                                            @if ($allow_delete)
                                                <button class="btn  btn-danger btn-sm badge" title="Delete"
                                                    onclick="confirmDelete('{{ route('guests.destroy', $guest->id) }}');">
