        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="mb-3 text-end">
                    @if ($allow_create)
                        <a href="{{ route('amenities.create') }}" class="btn bg-primary btn-sm badge"
                ...
                {{--  --------------------------------- export ------------------------------------- --}}
                <form action="{{ route('amenities.export') }}" method="get">
                    <div class="mb-3 text-end">
                        <div class="input-group w-100">
                            <div class="col">
                            ...
                            <button type="submit" class="btn btn-success">
                                <i class="fa fa-file" aria-hidden="true" title="Export"></i>
                            </button>
                        </div>
                    </div>
                </form>
                            ...
                            <tbody>
                                @foreach ($amenities as $amenit)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($allow_show)
                                                <a href="{{ route('amenities.show', $amenit->id) }}"
                                                    class="btn btn-warning btn-sm badge" title="Show">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                </a>
                                            @endif
                                            @if ($allow_edit)
                                                <a href="{{ route('amenities.edit', $amenit->id) }}"
                                            ...
                                            @if ($allow_delete)
                                                <button class="btn btn-danger btn-sm badge" title="Delete"
                                                    onclick="confirmDelete('{{ route('amenities.destroy', $amenit->id) }}');">
    ...
    <div class="modal fade" id="import" tabindex="-1" aria-labelledby="formModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('amenities.import') }}" method="POST" enctype="multipart/form-data"
                    id="modalForm">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
