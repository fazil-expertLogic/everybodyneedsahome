        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="mb-3 text-end">
                    @if ($allow_create)
                        <a href="{{ route('plan_menus.create') }}" class="btn bg-primary btn-sm badge"
                            ...
                            <tbody>
                                @foreach ($plan_menus as $plan_menu)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($allow_show)
                                                <a href="{{ route('plan_menus.show', $plan_menu->id) }}"
                                                    class="btn btn-warning btn-sm badge" title="Show">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                </a>
                                            @endif
                                            @if ($allow_edit)
                                                <a href="{{ route('plan_menus.edit', $plan_menu->id) }}"
                                            ...
                                            @if ($allow_delete)
                                                <button class="btn btn-danger btn-sm badge" title="Delete"
                                                    onclick="confirmDelete('{{ route('plan_menus.destroy', $plan_menu->id) }}');">
    ...
    <div class="modal fade" id="import" tabindex="-1" aria-labelledby="formModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('plan_menus.import') }}" method="POST" enctype="multipart/form-data"
                    id="modalForm">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
