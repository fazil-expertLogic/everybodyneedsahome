        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-wrap clearfix">
                    <div class="col-md-12">
                        <form method="post" action="{{ route('plan_permissions.store') }}" id="signUpForm" class="signUpForm"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_cus_is_child">
                                                    ...
                                                    <select name="plan_id" class="form-select" id="plan_id" aria-label="" required data-error="Please select plan_id">
                                                ...
                                                @foreach ( $plan_menus as $key => $plan_menu)
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-2 col-lg-2">
                                                            <input type="checkbox" id="is_view" name="permissions[{{$plan_menu->id}}][is_view]" value="1">
