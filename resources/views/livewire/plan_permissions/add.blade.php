        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-wrap clearfix">
                    <div class="col-md-12">
                        <form method="post" action="{{ route('permissions.store') }}" id="signUpForm" class="signUpForm"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_cus_is_child">
                                                    ...
                                                    <select name="role" class="form-select" id="role" aria-label="" required data-error="Please select Role">
