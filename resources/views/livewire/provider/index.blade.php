        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="mb-3 text-end"> <!-- Add text-end class here -->
                    @if ($allow_create)
                        <a href="{{ route('providers.create') }}" class="btn bg-primary btn-sm badge"
                            data-bs-toggle="tooltip" title="Add New">
                            <span><i class="fa fa-plus"></i></span>
                        </a>
                    @endif
                </div>
                <form action="{{ route('providers.index') }}" method="GET">
                    <div class="mb-3 text-end">
                        <div class="input-group w-100">
                            ...
                            <div class="col">
                                <input type="text" name="provider_email" class="form-control"
                                    placeholder="Provider Email" value="{{ request('provider_email') }}">
                            </div>
                            <div class="col">
                                <input type="text" name="provider_company_name" class="form-control"
                                    placeholder="Provider Company Name" value="{{ request('provider_company_name') }}">
                            </div>
                ...
                {{--  --------------------------------- export ------------------------------------- --}}
                <form action="{{ route('providers.export') }}" method="get">
                    <div class="mb-3 text-end">
                        <div class="input-group w-100">
                            <div class="col">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered text-nowrap border-bottom" id="responsive-datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">provider Email</th>
                                    <th class="wd-20p border-bottom-0">provider Comany Name</th>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p>Total Entries: {{ $providers->total() }}</p>
