                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_use_name">
                                                    ...
                                                    <input type="text" name="name" class="form-control py-2" id="name" placeholder="Your name" value="{{ old('name',$user->name) }}" required data-error="Please enter name">
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_use_email">
                                                    ...
                                                    <input type="email" name="email" class="form-control py-2" id="email" placeholder="example@email.com" value="{{ old('email',$user->email) }}" required data-error="Please enter email">
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
