        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="mb-3 text-end">
                    @if ($allow_create)
                        <a href="{{ route('users.create') }}" class="btn bg-primary btn-sm badge" data-bs-toggle="tooltip"
                            title="Add New">
    ...
    <div class="modal fade" id="import" tabindex="-1" aria-labelledby="formModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('users.import') }}" method="POST" enctype="multipart/form-data" id="modalForm">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
