        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="mb-3 text-end">
                    @if ($allow_create)
                        <a href="{{ route('properties.add') }}" class="btn bg-primary btn-sm badge" data-bs-toggle="tooltip"
                            title="Add New">
                                            ...
                                            <td>
                                                ...
                                                @if ($allow_delete)
                                                    <button class="btn btn-danger btn-sm badge" title="Delete"
                                                        onclick="confirmDelete('{{ route('properties.destroy', $property->id) }}');">
                                    ...
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination justify-content-center mb-0">
                                            ...
                                            @for ($i = 1; $i <= $properties->lastPage(); $i++)
                                                <li
                                                    class="page-item {{ $properties->currentPage() == $i ? 'active' : '' }}">
                                                    <a class="page-link"
