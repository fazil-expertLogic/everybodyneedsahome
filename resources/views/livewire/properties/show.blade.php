                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_property_name @if ($errors->has('property_name')) has-error has-danger @endif">
                                                    ...
                                                    <input type="text" disabled name="property_name" class="form-control py-2" value="{{$property->property_name}}" id="property_name" placeholder="Enter Property Name" required data-error="Please enter the Property Name.">
                                            ...
                                            <div class="col-sm-6 col-lg-6 form-group valid_property_description @if ($errors->has('property_description')) has-error has-danger @endif">
                                                ...
                                                <textarea disabled class="form-control" id="property_description" name="property_description"  required data-error="Please enter the Property Description.">{{$property->property_description}}</textarea>
                                                <div class="help-block with-errors"></div>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_property_address @if ($errors->has('property_address')) has-error has-danger @endif">
                                                    ...
                                                    <input type="text" disabled name="property_address" class="form-control py-2" value="{{$property->property_address}}" id="property_address" placeholder="Enter Property Address" required data-error="Please enter the Property Address.">
                                                    <div class="help-block with-errors"></div>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_city @if ($errors->has('city')) has-error has-danger @endif">
                                                    ...
                                                    <input type="text" disabled name="city" class="form-control py-2" value="{{$property->city}}" id="city" placeholder="Enter Property City" required data-error="Please enter the Property city.">
                                                    <div class="help-block with-errors"></div>
                                                    @if ($errors->has('city'))
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_state @if ($errors->has('state')) has-error has-danger @endif">
                                                    ...
                                                    <select disabled name="state" class="form-select" id="state" aria-label="" required data-error="Please select state">
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_zipcode @if ($errors->has('zipcode')) has-error has-danger @endif">
                                                    ...
                                                    <input type="text" disabled name="zipcode" class="form-control py-2" value="{{$property->zipcode}}" id="zipcode" placeholder="Enter Property zipcode" required data-error="Please enter the Property zipcode.">
                                                    <div class="help-block with-errors"></div>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_category @if ($errors->has('category')) has-error has-danger @endif">
                                                    ...
                                                    <select disabled name="category_id" class="form-select" id="category" aria-label="" required data-error="Please select category">
                                                        <option value="">Please Select</option>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group">
                                                    <input disabled type="checkbox" name="is_feature" id="is_feature" value="1" {{ old('is_feature') ? 'checked' : '' }} @if($property->is_feature == 1) checked @endif>
                                                    <label for="is_feature">Is Featured</label>
                                                    &nbsp;&nbsp;
                                                    <input disabled type="checkbox" name="is_new" id="is_new" value="1" {{ old('is_new') ? 'checked' : '' }} @if($property->is_new == 1) checked @endif>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_property_management_address @if ($errors->has('property_management_address')) has-error has-danger @endif">
                                                    ...
                                                    <input type="text" disabled name="property_management_address" class="form-control py-2" value="{{$property->property_management_address}}" id="property_management_address" placeholder="Enter Property Management Address" required data-error="Please enter the Property Management Address.">
                                                    <div class="help-block with-errors"></div>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_property_management_city @if ($errors->has('property_management_city')) has-error has-danger @endif">
                                                    ...
                                                    <input type="text" disabled name="property_management_city" class="form-control py-2" value="{{$property->property_management_city}}" id="property_management_city" placeholder="Enter Property property_management_city" required data-error="Please enter the Property Management City.">
                                                    <div class="help-block with-errors"></div>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_property_management_state  @if ($errors->has('property_management_state')) has-error has-danger @endif">
                                                    ...
                                                    <select disabled name="property_management_state" class="form-select" id="property_management_state" aria-label="" required data-error="Please select property_management_state">
                                                        <option value="">Please Select</option>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_property_management_zipcode @if ($errors->has('property_management_zipcode')) has-error has-danger @endif">
                                                    ...
                                                    <input type="text" disabled name="property_management_zipcode" class="form-control py-2" value="{{$property->property_management_zipcode}}" id="property_management_zipcode" placeholder="Enter Property zipcode" required data-error="Please enter the Property zipcode.">
                                                    <div class="help-block with-errors"></div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_number_of_beds @if ($errors->has('number_of_beds')) has-error has-danger @endif">
                                                    ...
                                                    <input type="number" disabled name="number_of_beds" class="form-control py-2" value="{{$property->number_of_beds}}" id="number_of_beds" placeholder="How many beds are available to rent" required data-error="Please enter How many beds are available to rent">
                                                    <div class="help-block with-errors"></div>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_rent_bed @if ($errors->has('rent_bed')) has-error has-danger @endif">
                                                    ...
                                                    <input type="number" disabled name="rent_bed" class="form-control py-2" value="{{$property->rent_bed}}" id="rent_bed" placeholder="Please enter the number of Beds." required data-error="Please enter the number of Beds.">
                                                    <div class="help-block with-errors"></div>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_bed_deposit @if ($errors->has('bed_deposit')) has-error has-danger @endif">
                                                    ...
                                                    <input type="number" disabled name="bed_deposit" class="form-control py-2" value="{{$property->bed_deposit}}" id="bed_deposit" placeholder="Please enter the Deposit." required data-error="Please enter the Deposit.">
                                                    <div class="help-block with-errors"></div>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_bed_fee @if ($errors->has('bed_fee')) has-error has-danger @endif">
                                                    ...
                                                    <input type="number" disabled name="bed_fee" class="form-control py-2" value="{{$property->bed_fee}}" id="bed_fee" placeholder="Please enter the Fee." required data-error="Please enter the Fee.">
                                                    <div class="help-block with-errors"></div>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_number_of_bedrooms @if ($errors->has('number_of_bedrooms')) has-error has-danger @endif">
                                                    ...
                                                    <input type="number" disabled name="number_of_bedrooms" class="form-control py-2" value="{{$property->number_of_bedrooms}}" id="number_of_bedrooms" placeholder="How many bedrooms are available to rent" required data-error="Please enter How many bedrooms are available to rent">
                                                    <div class="help-block with-errors"></div>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_stay_one_bedroom @if ($errors->has('stay_one_bedroom')) has-error has-danger @endif">
                                                    ...
                                                    <input type="number" disabled name="stay_one_bedroom" class="form-control py-2" value="{{$property->stay_one_bedroom}}" id="stay_one_bedroom" placeholder=" Please enter the number Of People allowed to stay in one bedroom." required data-error=" Please enter the number Of People allowed to stay in one bedroom.">
                                                    <div class="help-block with-errors"></div>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_bedroom_deposit @if ($errors->has('bedroom_deposit')) has-error has-danger @endif">
                                                    ...
                                                    <input type="number" disabled name="bedroom_deposit" class="form-control py-2" value="{{$property->bedroom_deposit}}" id="bedroom_deposit" placeholder="Please enter the Deposit." required data-error="Please enter the Deposit.">
                                                    <div class="help-block with-errors"></div>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_bedroom_fee @if ($errors->has('bedroom_fee')) has-error has-danger @endif">
                                                    ...
                                                    <input type="number" disabled name="bedroom_fee" class="form-control py-2" value="{{$property->bedroom_fee}}" id="bedroom_fee" placeholder="Please enter Fee." required data-error="Please enter fee.">
                                                    <div class="help-block with-errors"></div>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_number_of_bedrooms_house @if ($errors->has('number_of_bedrooms_house')) has-error has-danger @endif">
                                                    ...
                                                    <input type="number" disabled name="number_of_bedrooms_house" class="form-control py-2" value="{{$property->number_of_bedrooms_house}}" id="number_of_bedrooms_house" placeholder=" Please enter the number of bedrooms are there in the house." required data-error=" Please enter the number of bedrooms are there in the house.">
                                                    <div class="help-block with-errors"></div>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_number_of_bath_house @if ($errors->has('number_of_bath_house')) has-error has-danger @endif">
                                                    ...
                                                    <input type="number" disabled name="number_of_bath_house" class="form-control py-2" value="{{$property->number_of_bath_house}}" id="number_of_bath_house" placeholder="Please enter the number Of baths are there in the house." required data-error="Please enter the number Of baths are there in the house.">
                                                    <div class="help-block with-errors"></div>
                                            ...
                                            <div class="col-sm-6 col-lg-6 form-group valid_utilities_inscluded @if ($errors->has('utilities_inscluded')) has-error has-danger @endif">
                                                ...
                                                <select disabled class="form-select mb-3" name="utilities_inscluded" id="utilities_inscluded" required data-error="Please select">
                                                    <option value="">Please select</option>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_rent_unit @if ($errors->has('rent_unit')) has-error has-danger @endif">
                                                    ...
                                                    <input type="number" disabled name="rent_unit" class="form-control py-2" value="{{$property->rent_unit}}" id="rent_unit" placeholder="Please enter Rent for the Unit/House." required data-error="Please enter Rent for the Unit/House.">
                                                    <div class="help-block with-errors"></div>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_unit_deposit @if ($errors->has('unit_deposit')) has-error has-danger @endif">
                                                    ...
                                                    <input type="number" disabled name="unit_deposit" class="form-control py-2" value="{{$property->unit_deposit}}" id="unit_deposit" placeholder="Please enter the Deposit." required data-error="Please enter the Deposit.">
                                                    <div class="help-block with-errors"></div>
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_unit_fee @if ($errors->has('unit_fee')) has-error has-danger @endif">
                                                    ...
                                                    <input type="number" disabled name="unit_fee" class="form-control py-2" value="{{$property->unit_fee}}" id="unit_fee" placeholder="Please enter Fee." required data-error="Please enter fee.">
                                                    <div class="help-block with-errors"></div>
                                            ...
                                            <div class="col-sm-6 col-lg-6 form-group valid_is_property_occupied @if ($errors->has('is_property_occupied')) has-error has-danger @endif">
                                                ...
                                                <select  disabled class="form-select mb-3" name="is_property_occupied" id="is_property_occupied" required data-error="Please select">
                                                    <option value="">Please select</option>
                                                    <option  @if($property->is_property_occupied == '1') selected @endif value="1">Yes</option>
                                                    <option  @if($property->is_property_occupied == '0') selected @endif value="0">No</option>
                                                </select>
...
@endsection
@section('js')
<script src="{{asset('wizard-form/js/property-show.js')}}"></script>
@endsection