    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Show Property Detail</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <label for="property_name" class="form-label">Property Name</label>
                        <input class="form-control" value="{{$property->property_name}}" disabled>

                    </div>
                    <div class="col-md-6">
                        <label for="property_address" class="form-label">Property Address</label>
                        <input class="form-control" value="{{$property->property_address}}" disabled>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input class="form-control" id="city" value="{{$property->city}}" disabled>

                    </div>
                    <div class="col-md-6">
                        <label for="state" class="form-label">State</label>
                        <select name="state" class="form-select select2" id="state" disabled>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="number" name="zipcode" class="form-control" id="zipcode" value="{{$property->zipcode}}" disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <input name="property_management_address" type="text" class="form-control" id="property_management_address"
                            value="{{$property->property_management_address}}" disabled>
                        <div class="valid-feedback">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input name="property_management_city" type="text" class="form-control" id="property_management_city"
                            value="{{$property->property_management_city}}" disabled>

                    </div>

                    <div class="col-md-6">
                        <label for="property_management_state" class="form-label">Property Management State</label>
                        <select class="form-select select2" name="property_management_state" id="property_management_state" disabled>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" name="property_management_zipcode" id="property_management_zipcode" value="{{$property->property_management_zipcode}}" disabled>
                        <div class="valid-feedback">
                            Please enter the zipcode.
                        </div>
                    </div>
