                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_use_name @if ($errors->has('price')) has-error has-danger @endif">
                                                    ...
                                                    <input type="number" name="price" class="form-control py-2" id="price" placeholder="price" value="{{old('price',$membership->price)}}" required data-error="Please enter price">
                                                    <div class="help-block with-errors"></div>
                                                    @if ($errors->has('price'))
