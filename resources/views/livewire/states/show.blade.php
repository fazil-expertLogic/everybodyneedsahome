                        ...
                        <form method="post" action="{{ route('states.update', $state->id) }}" id="signUpForm" class="signUpForm"
                            ...
                            <div class="signUpForm-step-holder">
                                <div id="section-1" class="signUpForm-step-wrap">
                                    <fieldset>
                                        <h3 class="section-form-title">view State Detail</h3>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_use_name">
                                                    ...
                                                    <input type="text" name="name" class="form-control py-2" id="name" placeholder="name" value="{{$state->name}}" required data-error="Please enter name" disabled>
