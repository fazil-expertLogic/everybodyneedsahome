        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="mb-3 text-end">
                    @if ($allow_create)
                        <a href="{{ route('purchase_plans.create') }}" class="btn bg-primary btn-sm badge"
                ...
                {{--  --------------------------------- export ------------------------------------- --}}
                <form action="{{ route('purchase_plans.export') }}" method="get">
                    <div class="mb-3 text-end">
                        <div class="input-group w-100">
                            <div class="col">
                            ...
                            <tbody>
                                @foreach ($purchase_plans as $purchase_plan)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($allow_show)
                                                <a href="{{ route('purchase_plans.show', $purchase_plan->id) }}"
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center mb-0">
                                        ...
                                        @for ($i = 1; $i <= $purchase_plans->lastPage(); $i++)
                                            <li
                                                class="page-item {{ $purchase_plans->currentPage() == $i ? 'active' : '' }}">
                                                <a class="page-link"
                                                    href="{{ $purchase_plans->url($i) }}">{{ $i }}</a>
                                            </li>
                                        @endfor
    ...
    <div class="modal fade" id="import" tabindex="-1" aria-labelledby="formModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('purchase_plans.import') }}" method="POST" enctype="multipart/form-data"
                    id="modalForm">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
