                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-6">
                                                <div
                                                    class="form-group valid_user_id @if ($errors->has('user_id')) has-error has-danger @endif">
                                                    <label for="user_id" class="form-label">User<span
                                                            class="text-danger">*</span></label>
                                                    <select name="user_id" class="form-select" id="user_id" aria-label=""
                                                        required data-error="Please select user">
                                                    ...
                                                    @if ($errors->has('user_id'))
                                                        <div class="help-block with-errors">{{ $errors->first('user_id') }}
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                                ...
                                                <div
                                                    ...
                                                    <select name="member_ship_id" class="form-select" id="member_ship_id"
                                                        ...
                                                        @foreach ($member_ships as $member_ship_id => $member_ship)
                                                            <option value="{{ $member_ship_id }}">{{ $member_ship }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    <div class="help-block with-errors"></div>
                                                    @if ($errors->has('member_ship_id'))
                                                        <div class="help-block with-errors">
                                                            {{ $errors->first('member_ship_id') }}</div>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-6 col-lg-6">
                                            ...
                                            <div class="form-group signUpForm-step-1" style="margin-top: 50px;">
                                                ...
                                                <button id="Submit" class="btn btn-custom float-end" type="submit"
                                                    onclick="nextStep2()">Submit </button>
                                            </div>
                                    </fieldset>
                                </div>
