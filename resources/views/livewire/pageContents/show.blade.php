                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-lg-6">
                                                <div class="form-group valid_text @if ($errors->has('text')) has-error has-danger @endif">
                                                    ...
                                                    <input type="text" name="text" class="form-control py-2" id="text" placeholder="Text" value="{{old('text',$pageContent->text)}}" required data-error="Please enter text" disabled>
                                                    <div class="help-block with-errors"></div>
                                                    @if ($errors->has('text'))
